const collectUserDetails = async (user, dmChannel, callback) => {
    ...
    const askQuestion = async (questionIndex = 0) => {
        if (questionIndex < questions.length) {
            ...
            await dmChannel.send("🙌 Thank you for providing your details! We’re excited to help you achieve your fitness goals. Stay tuned for your personalized plans! 🏋️‍♂️🥗");
        }
    };
